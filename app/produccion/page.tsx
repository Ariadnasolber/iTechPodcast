      ...
      <section className="py-20">
        <div className="container mx-auto px-6 max-w-4xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-16">
            <Card className="rounded-3xl border border-gray-100 dark:border-gray-700 shadow-lg">
          ...
          <div className="bg-gray-50 dark:bg-gray-900 rounded-3xl p-8">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              <div className="bg-white dark:bg-gray-800 rounded-2xl p-4 text-center shadow-sm">
                <img src="/placeholder.svg?height=80&width=80" alt="Audacity" className="w-16 h-16 mx-auto mb-3" />
                <h3 className="font-medium">Audacity</h3>
                <p className="text-sm text-gray-500 dark:text-gray-400">Grabación y edición</p>
              </div>
              <div className="bg-white dark:bg-gray-800 rounded-2xl p-4 text-center shadow-sm">
                <img src="/placeholder.svg?height=80&width=80" alt="FFmpeg" className="w-16 h-16 mx-auto mb-3" />
                <h3 className="font-medium">FFmpeg</h3>
                <p className="text-sm text-gray-500 dark:text-gray-400">Conversión de audio</p>
              </div>
              <div className="bg-white dark:bg-gray-800 rounded-2xl p-4 text-center shadow-sm">
                <img
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400">Masterización</p>
              </div>
              <div className="bg-white dark:bg-gray-800 rounded-2xl p-4 text-center shadow-sm">
                <img src="/placeholder.svg?height=80&width=80" alt="Canva" className="w-16 h-16 mx-auto mb-3" />
                <h3 className="font-medium">Canva</h3>
                <p className="text-sm text-gray-500 dark:text-gray-400">Diseño de portadas</p>
              </div>
            </div>
          </div>
        </div>
