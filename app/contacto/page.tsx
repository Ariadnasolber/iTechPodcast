        ...
        <div className="container mx-auto px-6">
          <div className="max-w-3xl mx-auto">
            <Tabs defaultValue="contacto" className="mb-8">
              <TabsList className="grid w-full grid-cols-2 rounded-full p-1 bg-gray-100 dark:bg-gray-800">
                <TabsTrigger
                  value="contacto"
                  ...
                  <form className="space-y-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="border-2 border-dashed border-gray-300 dark:border-gray-700 rounded-xl p-6 text-center">
                        ...
                        <p className="text-xs text-gray-500 dark:text-gray-400 mt-2">MP3 o WAV, máximo 20MB</p>
                      </div>
                    </div>
                    <Button type="submit" className="w-full rounded-full bg-blue-600 hover:bg-blue-700 text-white">
