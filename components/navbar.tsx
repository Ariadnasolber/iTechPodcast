      ...
      <div className="container mx-auto px-6">
        <div className="flex items-center justify-between h-16">
          ...
          <Link href="/" className="flex items-center">
            <span className="text-xl font-semibold">SoundWaves</span>
          </Link>
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            <Button className="rounded-full bg-blue-600 hover:bg-blue-700 text-white px-6">Suscribirse</Button>
          </div>
        ...
        <div className="md:hidden bg-white/95 dark:bg-gray-950/95 backdrop-blur-md border-t border-gray-200 dark:border-gray-800">
          <div className="container mx-auto px-6 py-6">
            <nav className="flex flex-col space-y-6">
              ...
              <Button className="rounded-full bg-blue-600 hover:bg-blue-700 text-white w-full mt-2">Suscribirse</Button>
            </nav>
          </div>
        </div>
      )}
